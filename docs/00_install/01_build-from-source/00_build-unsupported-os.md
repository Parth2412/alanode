---
content_title: Build Alacrityio from Source on Other Unix-based OS
---
...
For the official multi-platform support try [Docker Utilities for Node Execution](https://github.com/AlacrityioIO/DUNE) which runs in an ubuntu image via a docker container.
...
Some other tests are available and recommended but be aware they can be sensitive to other software running on the same host and they may **SIGKILL** other alanode instances running on the host.
