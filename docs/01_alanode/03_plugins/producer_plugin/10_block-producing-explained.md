...
peer validation for similar hardware/alaio-version/config will be <= m
...
Running wasm-runtime=ala-vm-jit ala-vm-oc-enable on relay node will reduce the validation time.
