...
```console
# config.ini
plugin = alaio::producer_plugin [options]
```
...
```console
Config Options for alaio::producer_plugin:
  ...
  --private-key arg                     (DEPRECATED - Use signature-provider
                                        ...
                                        times)
  --signature-provider arg (=ALA6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV=KEY:5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3)
                                        ...
                                        Where:
                                           ...
                                           KALAD:<data>    is the URL where
                                                           kalad is available
                                                           and the approptiate
                                                           wallet(s) are
                                                           unlocked
  --kalad-provider-timeout arg (=5)     Limits the maximum time (in
                                        milliseconds) that is allowed for
                                        sending blocks to a kalad provider for
                                        signing
