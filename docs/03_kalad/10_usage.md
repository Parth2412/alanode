---
content_title: Kalad Usage
---

[[info | Recommended Usage]]
| For most users, the easiest way to use `kalad` is to have `alacli` launch it automatically. Wallet files will be created in the default directory (`~/alaio-wallet`).
