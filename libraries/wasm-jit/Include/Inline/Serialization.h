...
namespace Serialization
{
	...
	{ 
      if ( numBytes < alaio::chain::wasm_constraints::wasm_page_size || !WASM::check_limits)
	...
	{
      constexpr size_t max_size = alaio::chain::wasm_constraints::maximum_func_local_bytes;
