...
struct code_tuple {
   alaio::chain::digest_type code_id;
   uint8_t vm_version;
...
using alavmoc_message = std::variant<initialize_message,
...
FC_REFLECT(alaio::chain::alavmoc::initialize_message, )
FC_REFLECT(alaio::chain::alavmoc::initalize_response_message, (error_message))
FC_REFLECT(alaio::chain::alavmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(alaio::chain::alavmoc::compile_wasm_message, (code))
FC_REFLECT(alaio::chain::alavmoc::evict_wasms_message, (codes))
FC_REFLECT(alaio::chain::alavmoc::code_compilation_result_message, (start)(apply_offset)(starting_memory_pages)(initdata_prologue_size))
FC_REFLECT(alaio::chain::alavmoc::compilation_result_unknownfailure, )
FC_REFLECT(alaio::chain::alavmoc::compilation_result_toofull, )
FC_REFLECT(alaio::chain::alavmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes))
