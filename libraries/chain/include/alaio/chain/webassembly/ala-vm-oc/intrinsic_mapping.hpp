...
} // ns alaio::chain::alavmoc::detail

inline constexpr auto get_intrinsic_table() {
   return detail::generate_table(
      "alavmoc_internal.unreachable",
      "alavmoc_internal.grow_memory",
      "alavmoc_internal.div0_or_overflow",
      "alavmoc_internal.indirect_call_mismatch",
      "alavmoc_internal.indirect_call_oob",
      "alavmoc_internal.depth_assert",
      "alaio_injection.call_depth_assert",  //now unused; left for purposes of not upsetting existing code mappings
      "alaio_injection.checktime",          //now unused; left for purposes of not upsetting existing code mappings
      "env.__ashlti3",
      "env.__ashrti3",
      "env.__lshlti3",
      "env.__lshrti3",
      ...
      "env.abort",
      "env.alaio_assert",
      "env.alaio_assert_message",
      "env.alaio_assert_code",
      "env.alaio_exit",
      ...
      "env.memcmp",
      "env.memset",
      "alaio_injection._alaio_f32_add",
      "alaio_injection._alaio_f32_sub",
      "alaio_injection._alaio_f32_mul",
      "alaio_injection._alaio_f32_div",
      "alaio_injection._alaio_f32_min",
      "alaio_injection._alaio_f32_max",
      "alaio_injection._alaio_f32_copysign",
      "alaio_injection._alaio_f32_abs",
      "alaio_injection._alaio_f32_neg",
      "alaio_injection._alaio_f32_sqrt",
      "alaio_injection._alaio_f32_ceil",
      "alaio_injection._alaio_f32_floor",
      "alaio_injection._alaio_f32_trunc",
      "alaio_injection._alaio_f32_nearest",
      "alaio_injection._alaio_f32_eq",
      "alaio_injection._alaio_f32_ne",
      "alaio_injection._alaio_f32_lt",
      "alaio_injection._alaio_f32_le",
      "alaio_injection._alaio_f32_gt",
      "alaio_injection._alaio_f32_ge",
      "alaio_injection._alaio_f64_add",
      "alaio_injection._alaio_f64_sub",
      "alaio_injection._alaio_f64_mul",
      "alaio_injection._alaio_f64_div",
      "alaio_injection._alaio_f64_min",
      "alaio_injection._alaio_f64_max",
      "alaio_injection._alaio_f64_copysign",
      "alaio_injection._alaio_f64_abs",
      "alaio_injection._alaio_f64_neg",
      "alaio_injection._alaio_f64_sqrt",
      "alaio_injection._alaio_f64_ceil",
      "alaio_injection._alaio_f64_floor",
      "alaio_injection._alaio_f64_trunc",
      "alaio_injection._alaio_f64_nearest",
      "alaio_injection._alaio_f64_eq",
      "alaio_injection._alaio_f64_ne",
      "alaio_injection._alaio_f64_lt",
      "alaio_injection._alaio_f64_le",
      "alaio_injection._alaio_f64_gt",
      "alaio_injection._alaio_f64_ge",
      "alaio_injection._alaio_f32_promote",
      "alaio_injection._alaio_f64_demote",
      "alaio_injection._alaio_f32_trunc_i32s",
      "alaio_injection._alaio_f64_trunc_i32s",
      "alaio_injection._alaio_f32_trunc_i32u",
      "alaio_injection._alaio_f64_trunc_i32u",
      "alaio_injection._alaio_f32_trunc_i64s",
      "alaio_injection._alaio_f64_trunc_i64s",
      "alaio_injection._alaio_f32_trunc_i64u",
      "alaio_injection._alaio_f64_trunc_i64u",
      "alaio_injection._alaio_i32_to_f32",
      "alaio_injection._alaio_i64_to_f32",
      "alaio_injection._alaio_ui32_to_f32",
      "alaio_injection._alaio_ui64_to_f32",
      "alaio_injection._alaio_i32_to_f64",
      "alaio_injection._alaio_i64_to_f64",
      "alaio_injection._alaio_ui32_to_f64",
      "alaio_injection._alaio_ui64_to_f64",
