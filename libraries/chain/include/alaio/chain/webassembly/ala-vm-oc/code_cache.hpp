...
namespace std {
    template<> struct hash<alaio::chain::alavmoc::code_tuple> {
        size_t operator()(const alaio::chain::alavmoc::code_tuple& ct) const noexcept {
...
class code_cache_base {
   public:
      code_cache_base(const bfs::path data_dir, const alavmoc::config& alavmoc_config, const chainbase::database& db);
      ~code_cache_base();
...
class code_cache_async : public code_cache_base {
   public:
      code_cache_async(const bfs::path data_dir, const alavmoc::config& alavmoc_config, const chainbase::database& db);
      ~code_cache_async();
