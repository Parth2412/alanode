...
#include <alaio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(alaio::chain::table_id_object, alaio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(alaio::chain::key_value_object, alaio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(alaio::chain::index64_object, alaio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(alaio::chain::index128_object, alaio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(alaio::chain::index256_object, alaio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(alaio::chain::index_double_object, alaio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(alaio::chain::index_long_double_object, alaio::chain::index_long_double_index)

FC_REFLECT(alaio::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(alaio::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(alaio::chain::index64_object)
REFLECT_SECONDARY(alaio::chain::index128_object)
REFLECT_SECONDARY(alaio::chain::index256_object)
REFLECT_SECONDARY(alaio::chain::index_double_object)
REFLECT_SECONDARY(alaio::chain::index_long_double_object)
