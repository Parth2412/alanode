...
FC_REFLECT_ENUM( alaio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(alaio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(alaio::chain::transaction_receipt, (alaio::chain::transaction_receipt_header), (trx) )
FC_REFLECT(alaio::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(alaio::chain::signed_block, (alaio::chain::signed_block_header), (transactions)(block_extensions) )
