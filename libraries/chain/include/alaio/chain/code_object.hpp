...
CHAINBASE_SET_INDEX_TYPE(alaio::chain::code_object, alaio::chain::code_index)

FC_REFLECT(alaio::chain::code_object, (code_hash)(code)(code_ref_count)(first_block_used)(vm_type)(vm_version))
