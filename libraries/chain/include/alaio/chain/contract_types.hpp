...
using action_name    = alaio::chain::action_name;
...
FC_REFLECT( alaio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( alaio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( alaio::chain::setabi                           , (account)(abi) )
FC_REFLECT( alaio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( alaio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( alaio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( alaio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( alaio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( alaio::chain::onerror                          , (sender_id)(sent_trx) )
