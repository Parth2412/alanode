...
CHAINBASE_SET_INDEX_TYPE(alaio::chain::permission_object, alaio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(alaio::chain::permission_usage_object, alaio::chain::permission_usage_index)

FC_REFLECT(alaio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(alaio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(alaio::chain::permission_usage_object, (last_used))
