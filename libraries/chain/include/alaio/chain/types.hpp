...
namespace alaio { namespace chain {
   ...
   /**
    *  Important notes on using chainbase objects in ALAIO code:
    *
    ...
    *  others are due to requirements to ensure determinism in the ALAIO chain library.
    *
...
FC_REFLECT_EMPTY( alaio::chain::void_t )
