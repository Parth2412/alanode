...
CHAINBASE_SET_INDEX_TYPE(alaio::chain::permission_link_object, alaio::chain::permission_link_index)

FC_REFLECT(alaio::chain::permission_link_object, (account)(code)(message_type)(required_permission))
