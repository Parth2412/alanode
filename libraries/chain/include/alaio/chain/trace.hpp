...
#include <alaio/chain/action_receipt.hpp>
...
FC_REFLECT( alaio::chain::account_delta,
            (account)(delta) )

FC_REFLECT( alaio::chain::action_trace,
...
// @ignore except_ptr
FC_REFLECT( alaio::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
