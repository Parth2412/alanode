...
CHAINBASE_SET_INDEX_TYPE(alaio::chain::transaction_object, alaio::chain::transaction_multi_index)

FC_REFLECT(alaio::chain::transaction_object, (expiration)(trx_id))
