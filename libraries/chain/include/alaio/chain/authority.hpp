...
FC_REFLECT(alaio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(alaio::chain::key_weight, (key)(weight) )
FC_REFLECT(alaio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(alaio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(alaio::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(alaio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(alaio::chain::shared_public_key, (pubkey))
