...
CHAINBASE_SET_INDEX_TYPE(alaio::chain::generated_transaction_object, alaio::chain::generated_transaction_multi_index)

FC_REFLECT(alaio::chain::generated_transaction_object, (trx_id)(sender)(sender_id)(payer)(delay_until)(expiration)(published)(packed_trx))
