...
extern "C" {
   void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
      if( code == "alaio"_n.value && action == "onerror"_n.value ) {
         auto error = alaio::onerror::from_current_action();
         alaio::print("onerror called\n");
      ...
      //unhandled test call
      alaio_assert( false, "Unknown Test ahhh!" );
