#include <alaio/alaio.hpp>                   /* contract, datastream, check */
#include <alaio/privileged.hpp>              /* blockchain_parameters */
...
#define IMPORT extern "C" __attribute__((alaio_wasm_import))
...
class [[alaio::contract("params_test")]] params_test : public alaio::contract {
public:
   using alaio::contract::contract;

   [[alaio::action]] void maintest(){
