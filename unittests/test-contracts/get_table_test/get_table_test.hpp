...
class [[alaio::contract]] get_table_test : public alaio::contract {
    public:
    using alaio::contract::contract;

    // Number object
    struct [[alaio::table]] numobj {
        uint64_t        key;
        uint64_t        sec64;
        uint128_t       sec128;
        double          secdouble;
    ...
    typedef alaio::multi_index< "numobjs"_n, numobj, 
    ...
    typedef alaio::multi_index< "hashobjs"_n, hashobj, 
