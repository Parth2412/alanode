...
struct dummy_action {
   static alaio::chain::name get_name() { return "dummyaction"_n; }
   static alaio::chain::name get_account() { return "testapi"_n; }
...
struct cf_action {
   static alaio::chain::name get_name() { return "cfaction"_n; }
   static alaio::chain::name get_account() { return "testapi"_n; }
...
BOOST_AUTO_TEST_CASE(test_restart_with_different_chain_id) {
   ...
   genesis.initial_key       = alaio::testing::base_tester::get_public_key(config::system_account_name, "active");
