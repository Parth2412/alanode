...
#include <alaio/trace_api/common.hpp>
#include <alaio/trace_api/metadata_log.hpp>
#include <alaio/trace_api/data_log.hpp>
#include <alaio/trace_api/compressed_file.hpp>

namespace alaio::trace_api {
...
FC_REFLECT(alaio::trace_api::slice_directory::index_header, (version))
