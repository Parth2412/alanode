...
#include <alaio/signature_provider_plugin/signature_provider_plugin.hpp>
...
public:
   ...
   struct unapplied_trx {
      ...
      string                    trx_type; // alaio::chain::trx_enum_type values or "read_only"
...
FC_REFLECT(alaio::producer_plugin::runtime_options, (max_transaction_time)(max_irreversible_block_age)(produce_time_offset_us)(last_block_time_offset_us)(max_scheduled_transaction_time_per_block_ms)(subjective_cpu_leeway_us)(incoming_defer_ratio)(greylist_limit));
FC_REFLECT(alaio::producer_plugin::greylist_params, (accounts));
FC_REFLECT(alaio::producer_plugin::whitelist_blacklist, (actor_whitelist)(actor_blacklist)(contract_whitelist)(contract_blacklist)(action_blacklist)(key_blacklist) )
FC_REFLECT(alaio::producer_plugin::integrity_hash_information, (head_block_id)(integrity_hash))
FC_REFLECT(alaio::producer_plugin::snapshot_information, (head_block_id)(head_block_num)(head_block_time)(version)(snapshot_name))
FC_REFLECT(alaio::producer_plugin::scheduled_protocol_feature_activations, (protocol_features_to_activate))
FC_REFLECT(alaio::producer_plugin::get_supported_protocol_features_params, (exclude_disabled)(exclude_unactivatable))
FC_REFLECT(alaio::producer_plugin::get_account_ram_corrections_params, (lower_bound)(upper_bound)(limit)(reverse))
FC_REFLECT(alaio::producer_plugin::get_account_ram_corrections_result, (rows)(more))
FC_REFLECT(alaio::producer_plugin::get_unapplied_transactions_params, (lower_bound)(limit)(time_limit_ms))
FC_REFLECT(alaio::producer_plugin::unapplied_trx, (trx_id)(expiration)(trx_type)(first_auth)(first_receiver)(first_action)(total_actions)(billed_cpu_time_us)(size))
FC_REFLECT(alaio::producer_plugin::get_unapplied_transactions_result, (size)(incoming_size)(trxs)(more))
