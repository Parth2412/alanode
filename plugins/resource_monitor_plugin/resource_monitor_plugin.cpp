/**
   ...
   belons to is running out of space, alanode will crash with SIGBUS as
...
#include <alaio/resource_monitor_plugin/file_space_handler.hpp>
#include <alaio/resource_monitor_plugin/system_file_space_provider.hpp>
...
using namespace alaio::resource_monitor;
...
public:
   ...
   void set_program_options(options_description&, options_description& cfg) {
      cfg.add_options()
         ...
         ( "resource-monitor-not-shutdown-on-threshold-exceeded",
           "Used to indicate alanode will not shutdown when threshold is exceeded." )
   ...
   void plugin_initialize(const appbase::variables_map& options) {
      ...
      ALA_ASSERT(interval >= monitor_interval_min && interval <= monitor_interval_max, chain::plugin_config_exception,
      ...
      ALA_ASSERT(threshold >= space_threshold_min  && threshold <= space_threshold_max, chain::plugin_config_exception,
      ...
      ALA_ASSERT(warning_interval >= warning_interval_min && warning_interval <= warning_interval_max, chain::plugin_config_exception,
